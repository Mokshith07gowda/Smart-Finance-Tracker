...
const moneyBorrowedSchema = new mongoose.Schema({
  user: {
  ...
  totalAmount: {
    type: Number,
    required: [true, 'Please provide the total amount borrowed'],
...
moneyBorrowedSchema.pre('save', function(next) {
...
module.exports = mongoose.model('MoneyBorrowed', moneyBorrowedSchema);
